...
export default function SkillsSection() {
    ...
    return (
        <div className={cx(textCenter)}>
            <Grid container spacing={1} sx={{ marginTop: "1em", marginBottom: "2em", paddingBottom: "3em", boxShadow: "0px 13px 27px -5px #000, 0px 8px 16px -8px #222" }} id="skills">
                <Grid item xs={12}>
                    <Typography variant="h3" component="h3" color="white" sx={{ marginTop: "2em" }}>Skills</Typography>
                </Grid>
                <Grid item xs={12} sm={2} sx={{ marginTop: "3em" }}>
                    <Avatar
                        alt="HTML5 Icon"
                        src={htmlImage}
                ...
                <Grid item xs={12} sm={2} sx={{ marginTop: "3em" }}>
                    <Avatar
                        ...
                        className={cx(avatarStyles)}
                    />
                    <Typography variant="body1" sx={{ marginTop: "1.5em" }}>Adobe <br />Illustrator</Typography>
                </Grid>
                <Grid item xs={12} sm={2} sx={{ marginTop: "3em" }}>
                    <Avatar
                        ...
                        className={cx(avatarStyles)}
                    />
                    <Typography variant="body1" sx={{ marginTop: "1.5em" }}>Adobe <br />Photoshop</Typography>
                </Grid>
                <Grid item xs={12} sm={2} sx={{ marginTop: "3em" }}>
                    <Avatar
                        alt="Atlassian Icon"
                        ...
                        className={cx(avatarStyles)}
                    />
                    <Typography variant="body1" sx={{ marginTop: "1.5em" }}>Atlassian</Typography>
                </Grid>
                <Grid item xs={12} sm={2} sx={{ marginTop: "3em" }}>
                    <Avatar
                        alt="Jira Icon"
                        ...
                        className={cx(avatarStyles)}
                    />
                    <Typography variant="body1" sx={{ marginTop: "1.5em" }}>Jira</Typography>
                </Grid>
                <Grid item xs={12} sm={2} sx={{ marginTop: "3em" }}>
                    <Avatar
                        alt="Angular Icon"
                        ...
                        className={cx(avatarStyles)}
                    />
                    <Typography variant="body1" sx={{ marginTop: "1.5em" }}>Angular</Typography>
                </Grid>
                <Grid item xs={12} sm={2} sx={{ marginTop: "3em" }}>
                    <Avatar
                        alt="Bootstrap Icon"
                        ...
                        className={cx(avatarStyles)}
                    />
                    <Typography variant="body1" sx={{ marginTop: "1.5em" }}>Bootstrap</Typography>
                </Grid>
                <Grid item xs={12} sm={2} sx={{ marginTop: "3em" }}>
                    <Avatar
                        alt="C# Icon"
                        ...
                        className={cx(avatarStyles)}
                    />
                    <Typography variant="body1" sx={{ marginTop: "1.5em" }}>C#</Typography>
                </Grid>
                <Grid item xs={12} sm={2} sx={{ marginTop: "3em" }}>
                    <Avatar
                        alt="CSS3 Icon"
                ...
                <Grid item xs={12} sm={2} sx={{ marginTop: "3em" }}>
                    <Avatar
                        ...
                        className={cx(avatarStyles)}
                    />
                    <Typography variant="body1" sx={{ marginTop: "1.5em" }}>.NET</Typography>
                </Grid>
                <Grid item xs={12} sm={2} sx={{ marginTop: "3em" }}>
                    <Avatar
                        alt="Git Icon"
                        ...
                        className={cx(avatarStyles)}
                    />
                    <Typography variant="body1" sx={{ marginTop: "1.5em" }}>Git</Typography>
                </Grid>
                <Grid item xs={12} sm={2} sx={{ marginTop: "3em" }}>
                    <Avatar
                        alt="Github Icon"
                ...
                <Grid item xs={12} sm={2} sx={{ marginTop: "3em" }}>
                    <Avatar
                        ...
                        className={cx(avatarStyles)}
                    />
                    <Typography variant="body1" sx={{ marginTop: "1.5em" }}>Google <br />Analytics</Typography>
                </Grid>
                <Grid item xs={12} sm={2} sx={{ marginTop: "3em" }}>
                    <Avatar
                        alt="Gulp Icon"
                        ...
                        className={cx(avatarStyles)}
                    />
                    <Typography variant="body1" sx={{ marginTop: "1.5em" }}>Gulp</Typography>
                </Grid>
                <Grid item xs={12} sm={2} sx={{ marginTop: "3em" }}>
                    <Avatar
                        alt="Heroku Icon"
                        ...
                        className={cx(avatarStyles)}
                    />
                    <Typography variant="body1" sx={{ marginTop: "1.5em" }}>Heroku</Typography>
                </Grid>
                <Grid item xs={12} sm={2} sx={{ marginTop: "3em" }}>
                    <Avatar
                        alt="inVision Icon"
                        ...
                        className={cx(avatarStyles)}
                    />
                    <Typography variant="body1" sx={{ marginTop: "1.5em" }}>inVision</Typography>
                </Grid>
                <Grid item xs={12} sm={2} sx={{ marginTop: "3em" }}>
                    <Avatar
                        alt="JavaScript Icon"
                ...
                <Grid item xs={12} sm={2} sx={{ marginTop: "3em" }}>
                    <Avatar
                        ...
                        className={cx(avatarStyles)}
                    />
                    <Typography variant="body1" sx={{ marginTop: "1.5em" }}>jQuery</Typography>
                </Grid>
                <Grid item xs={12} sm={2} sx={{ marginTop: "3em" }}>
                    <Avatar
                        alt="JSON Icon"
                        ...
                        className={cx(avatarStyles)}
                    />
                    <Typography variant="body1" sx={{ marginTop: "1.5em" }}>JSON</Typography>
                </Grid>
                <Grid item xs={12} sm={2} sx={{ marginTop: "3em" }}>
                    <Avatar
                        alt="Mailchimp Icon"
                ...
                <Grid item xs={12} sm={2} sx={{ marginTop: "3em" }}>
                    <Avatar
                        ...
                        className={cx(avatarStyles)}
                    />
                    <Typography variant="body1" sx={{ marginTop: "1.5em" }}>Node JS</Typography>
                </Grid>
                <Grid item xs={12} sm={2} sx={{ marginTop: "3em" }}>
                    <Avatar
                        alt="MySQL Icon"
                        ...
                        className={cx(avatarStyles)}
                    />
                    <Typography variant="body1" sx={{ marginTop: "1.5em" }}>MySQL</Typography>
                </Grid>
                <Grid item xs={12} sm={2} sx={{ marginTop: "3em" }}>
                    <Avatar
                        alt="NPM Icon"
                        ...
                        className={cx(avatarStyles)}
                    />
                    <Typography variant="body1" sx={{ marginTop: "1.5em" }}>NPM</Typography>
                </Grid>
                <Grid item xs={12} sm={2} sx={{ marginTop: "3em" }}>
                    <Avatar
                        alt="PHP Icon"
                        ...
                        className={cx(avatarStyles)}
                    />
                    <Typography variant="body1" sx={{ marginTop: "1.5em" }}>PHP</Typography>
                </Grid>
                <Grid item xs={12} sm={2} sx={{ marginTop: "3em" }}>
                    <Avatar
                        alt="PostGRESQL Icon"
                        ...
                        className={cx(avatarStyles)}
                    />
                    <Typography variant="body1" sx={{ marginTop: "1.5em" }}>PostgreSQL</Typography>
                </Grid>
                <Grid item xs={12} sm={2} sx={{ marginTop: "3em" }}>
                    <Avatar
                        alt="ReactJS Icon"
                ...
                <Grid item xs={12} sm={2} sx={{ marginTop: "3em" }}>
                    <Avatar
                        ...
                        className={cx(avatarStyles)}
                    />
                    <Typography variant="body1" sx={{ marginTop: "1.5em" }}>Responsive <br />Design</Typography>
                </Grid>
                <Grid item xs={12} sm={2} sx={{ marginTop: "3em" }}>
                    <Avatar
                        alt="Salesforce Icon"
                        ...
                        className={cx(avatarStyles)}
                    />
                    <Typography variant="body1" sx={{ marginTop: "1.5em" }}>Salesforce</Typography>
                </Grid>
                <Grid item xs={12} sm={2} sx={{ marginTop: "3em" }}>
                    <Avatar
                        alt="SASS Icon"
                ...
                <Grid item xs={12} sm={2} sx={{ marginTop: "3em" }}>
                    <Avatar
                        ...
                        className={cx(avatarStyles)}
                    />
                    <Typography variant="body1" sx={{ marginTop: "1.5em" }}>Sketch</Typography>
                </Grid>
                <Grid item xs={12} sm={2} sx={{ marginTop: "3em" }}>
                    <Avatar
                        alt="Slack Icon"
                        ...
                        className={cx(avatarStyles)}
                    />
                    <Typography variant="body1" sx={{ marginTop: "1.5em" }}>Slack</Typography>
                </Grid>
                <Grid item xs={12} sm={2} sx={{ marginTop: "3em" }}>
                    <Avatar
                        alt="TypeScript Icon"
                        ...
                        className={cx(avatarStyles)}
                    />
                    <Typography variant="body1" sx={{ marginTop: "1.5em" }}>TypeScript</Typography>
                </Grid>
                <Grid item xs={12} sm={2} sx={{ marginTop: "3em" }}>
                    <Avatar
                        alt="UX UI Icon"
                        ...
                        className={cx(avatarStyles)}
                    />
                    <Typography variant="body1" sx={{ marginTop: "1.5em" }}>UX UI</Typography>
                </Grid>
                <Grid item xs={12} sm={2} sx={{ marginTop: "3em" }}>
                    <Avatar
                        alt="WordPress Icon"
                        ...
                        className={cx(avatarStyles)}
                    />
                    <Typography variant="body1" sx={{ marginTop: "1.5em" }}>WordPress</Typography>
                </Grid>
                <Grid item xs={12} sm={2} sx={{ marginTop: "3em" }}>
                    <Avatar
                        alt="Shopify Icon"
                        ...
                        className={cx(avatarStyles)}
                    />
                    <Typography variant="body1" sx={{ marginTop: "1.5em" }}>Shopify</Typography>
                </Grid>
            </Grid>
        </div>
    );
