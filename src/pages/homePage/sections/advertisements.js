    ...
    <div className={cx(textCenter, paddingTop)}>
      <div>
        ...
        <Typography paragraph className={cx(fontSize1)}>
          This website was developed using ReactJS, JavaScript, Material Design,
          CSS, and HTML5. The different looking style is based off a design
          pattern I call neomat, which blends concepts of Neumorphism and
          Material Design together. The design emphasis was to create a
          "texturized" feel to the website. Check out the code for this website
          on Github below.
        </Typography>
        <Link
        ...
        <Card>
          ...
          <CardContent>
            ...
            <Typography variant="body2" color="text.secondary">
              In the coming months, individuals will be able to purchase
              Montanye Creativity photography prints and have them shipped right
              to your door!
            </Typography>
          </CardContent>
      ...
      <div className={cx(my2)}>
        ...
        <Typography paragraph>
          I work by day as a Salesforce Commerce Cloud Developer. Trailhead has
          become my #1 resource aside from work to become B2C certified. Follow
          my Salesforce journey on Trailhead or connect with me on{" "}
          <Link
