  ...
  return (
    <div>
      <Typography variant="body1">
        I have worked many other projects that are not shown here as I do not
        have direct permission from clients to share works as per contracted
        agreements but those brands and sites include:{" "}
        <i>
          Citizen Watches, Bulova Watches, Accutron Watches, New Balance,
          Johnston &amp; Murphy, Sheet Music Plus, Cherished Memories,
          ReserveBar, LuxeDecor, SyllogisTeks, PohlmanUSA, and Our Lady's Inn.
        </i>{" "}
        See{" "}
        <Link
          href="/resume"
          title="See resume page"
        ...
        >
          ...
          <div className={cx(textMiddle, mx1)}>
            ...
            <Typography sx={{ width: "100%" }}>
              Wedding website built in Material Design 4.0 and React. Powered on
              the backend by POSTgres and Node.js.
            </Typography>
            <Link
      ...
      <div className={cx(marginTop)}>
        ...
        >
          ...
          <div className={cx(textMiddle, mx1)}>
            ...
            <Typography sx={{ width: "100%" }}>
              An enhanced README for my main GitHub repo. Highlights langauges
              and technologies I use as well as GitHub statistics that are
              updated daily from API.
            </Typography>
            <Link
      ...
      <div className={cx(marginTop)}>
        ...
        >
          ...
          <div className={cx(textMiddle, mx1)}>
            ...
            <Typography sx={{ width: "100%" }}>
              A local food finder app written in HTML5, CSS3, JavaScript,
              WordPress, and PHP. No longer actively maintained.
            </Typography>
            <Link
