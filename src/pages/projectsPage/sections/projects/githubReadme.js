      ...
      <div className={cx(main, px4, pb2)}>
          ...
          >
            ...
            >
              ...
              <TabPanel value={value} index={0}>
                ...
                >
                  <li>
                    Create a visually appealing user profile for GitHub website
                  </li>
                  <li>
                    Convey to other developers and recruiters current skillset
                    and a general understanding of preferred work
                  </li>
                  <li>
                    Create a dashboard of statistics for publishing code for
                    personal projects
                  </li>
                  <li>
                    Only use web development technologies available inside a
                    README file
                  </li>
                </ul>
              </TabPanel>
              <TabPanel value={value} index={1}>
                ...
                >
                  ...
                  <li>
                    Found existing API and utilized them for personal GitHub
                    stats to be displayed on page
                  </li>
                  <li>
                    Found fun icons, badges, and GIFs to add color and visual
                    depth to page
                  </li>
                  <li>
                    Thought about how to teach future developers how to build
                    page and added resources to bottom for more advanced section
                    creation
                  </li>
                </ul>
              </TabPanel>
              <TabPanel value={value} index={2}>
                ...
                >
                  <li>
                    Came up with visually appealing and fun story-telling of
                    personal biography, most used skills, and what am looking
                    for in future for work
                  </li>
                  <li>
                    Was able to compactly and effectively display a dashboard
                    with breakdowns on code pushing activity and most used
                    technologies
                  </li>
                  <li>
                    Implemented resources to help other developers with more
                    advanced sections of building a similar README file
                  </li>
                </ul>
              </TabPanel>
            </Box>
        ...
        >
          <Link
            ...
            title="See website at https://github.com/montanyecreative/montanyecreativegithub/blob/main/README.md"
            target="_blank"
            rel="noopener"
          >
            <Button
          ...
          <Link
            href="https://github.com/montanyecreative/montanyecreativegithub"
